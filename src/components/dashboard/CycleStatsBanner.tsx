...
export function CycleStatsBanner({ cycle }: CycleStatsBannerProps) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-2 rounded-xl border border-[#d6cabf] bg-[#F1EFE8] px-4 py-3 text-sm text-[#5F5E5A]">
      <Archive size={15} className="text-[#78716c]" />
