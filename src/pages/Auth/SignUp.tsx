        ...
        <div className="relative z-10">
          ...
          <ul className="mt-8 space-y-3">
            {[
              ...
              >
                <span className="w-5 h-5 rounded-full bg-[var(--c-s27ae60)]/30 flex items-center justify-center flex-shrink-0">
                  <svg
                    className="w-3 h-3 text-[var(--c-t2ecc71)]"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    strokeWidth={3}
            ...
            {passwordFeedback.length > 0 && (
              <div className="space-y-1">
                {passwordFeedback.map((msg, i) => (
                  <p
                    key={i}
                    className="text-xs text-[var(--c-te74c3c)] flex items-center gap-1"
                  >
                    <span>•</span> {msg}
                  </p>
                ))}
