    ...
    <>
      ...
      <div className="min-h-screen bg-color-bg">
            ...
            <div className="flex items-center justify-between gap-4 flex-wrap">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-[var(--c-sf5e6df)] rounded-xl flex items-center justify-center">
                  <FileText size={20} className="text-[var(--c-tc0694a)]" />
                </div>
                <div>
                  <h1 className="text-2xl font-bold text-[var(--c-t1c1917)]">{t('reply_templates.title')}</h1>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          {/* Tier gate */}
          {!canUseTemplates && (
            <div className="mb-6 flex items-start gap-3 p-5 bg-[var(--c-sffffff)] border border-[var(--c-be9e0d9)] rounded-xl">
              <Lock size={18} className="text-[var(--c-t8f8680)] mt-0.5 flex-shrink-0" />
              <div>
                <p className="text-sm font-semibold text-[var(--c-t1c1917)]">
                ...
                <button
                  ...
                  className="mt-3 text-sm font-medium text-[var(--c-tc0694a)] hover:underline"
                >
          ...
          {canUseTemplates && Number.isFinite(templateCap) && (
            <div className="mb-6 flex items-start gap-3 p-4 bg-[var(--c-sffffff)] border border-[var(--c-be9e0d9)] rounded-xl">
              <FileText size={18} className="text-[var(--c-t8f8680)] mt-0.5 flex-shrink-0" />
              <div>
                <p className="text-sm font-semibold text-[var(--c-t1c1917)]">
                ...
                {atTemplateLimit && (
                  <p className="text-sm text-[var(--c-t78716c)] mt-1">
                    ...
                    <button
                      onClick={() => navigate('/pricing')}
                      className="font-medium text-[var(--c-tc0694a)] hover:underline"
                    >
          ...
          {loading ? (
            ...
            <div className="text-center py-20 bg-[var(--c-sffffff)] border border-[var(--c-be9e0d9)] rounded-xl">
              <FileText size={36} className="mx-auto text-[var(--c-td6cabf)] mb-4" />
              <p className="text-[var(--c-t3c3632)] font-medium mb-1">{t('reply_templates.no_templates')}</p>
              <p className="text-sm text-[var(--c-t78716c)] max-w-xs mx-auto">
